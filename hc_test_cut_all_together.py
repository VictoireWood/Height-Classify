...
for idx in range(class_number):
    ...
    for time in range(times):
        h = random.uniform(range_start, range_end-0.0001)    # range_end可以被取到，所以要减去1
        flight_heights.append(h)

flight_heights = list(set(sorted(flight_heights)))
...
def generate_map_tiles(raw_map_path:str, patches_save_dir:str, rotation_angles=[0]):
    ...
    tbar = trange(len(flight_heights))
    i = 0
    ...
    #LINK: https://cameraharmony.com/wp-content/uploads/2020/03/focal-length-graphic-1-2048x1078.png
        ...
        flight_class = int((flight_height - h_min) // class_interval)
...
if __name__ == '__main__':
    ...
    # patches_save_root_dir = r'/root/workspace/crikff47v38s73fnfgdg/maps/HC-cities-test-new'
