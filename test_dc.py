...
if args.dataset_name == 'ct01':
    ...
    train_dataset_folders = ['2022']
    test_datasets = ['new_photo']
elif '2022' in args.dataset_name:
...
# 记录
# query_images_paths = test_dataset.images_paths      # 录入csv的query_paths
# query_images_heights = test_dataset.heights         # 录入csv的query_heights
# utms = get_utms_from_paths(query_images_paths)
# utms_e = [utm[0] for utm in utms]
# utms_n = [utm[1] for utm in utms]
...
# inference_with_groups(args, model, classifiers, test_dl, groups, test_img_num)
# if args.test_set_list 
